...
import com.example.hotel_management_application.adapters.AllBookingHistoryAdapter;
...
public class AllBookingHistoryActivity extends AppCompatActivity implements BookingViewFetchMessage {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AllBookingHistoryActivity.this, AdminPanelActivity.class);
...
//        ListDataView.setLayoutManager(mLayoutManager);
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(AllBookingHistoryActivity.this, message, Toast.LENGTH_LONG).show();
