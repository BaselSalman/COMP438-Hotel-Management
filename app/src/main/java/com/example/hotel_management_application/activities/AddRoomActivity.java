...
import com.example.hotel_management_application.roomapi.RoomUploadData;
import com.example.hotel_management_application.roomapi.RoomViewMessage;
...
//            uploadFile();
    ...
    public void onUpdateSuccess(String message) {
        Toast.makeText(AddRoomActivity.this, message, Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(AddRoomActivity.this, AdminPanelActivity.class);
