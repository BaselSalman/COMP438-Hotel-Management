...
import com.example.hotel_management_application.bookingapi.BookingUploadData;
import com.example.hotel_management_application.bookingapi.BookingViewMessage;
...
public class RoomPageActivity extends AppCompatActivity implements RoomViewFetchMessage, BookingViewMessage {
    ...
    public void onViewAllItems(View view) {
        Intent intent = new Intent(RoomPageActivity.this, ViewAllRoomsActivity.class);
    ...
    public void onProfilePage(View view) {
        Intent intent = new Intent(RoomPageActivity.this, UserProfileActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
