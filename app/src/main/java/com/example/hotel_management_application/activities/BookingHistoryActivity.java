...
import com.example.hotel_management_application.adapters.CurrentBookingAdapter;
...
public class BookingHistoryActivity extends AppCompatActivity implements BookingViewFetchMessage {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BookingHistoryActivity.this, UserMenuActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BookingHistoryActivity.this, UserProfileActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
            }
